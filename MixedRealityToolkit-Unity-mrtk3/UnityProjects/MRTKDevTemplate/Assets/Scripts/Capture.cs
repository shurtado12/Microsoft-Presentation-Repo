...
{	
    ...
    public void uponGrab(){// Entered upon held
     //   hasAlreadyCaptured = false;
        pieceIsGrabbed = true;
    }
    public void uponRelease(){//entered upon release
   ...
   if(gameObject.tag =="BlackPiece" && !Turn.whiteTurn && pieceIsGrabbed ){ // This is black turn
...
else if (gameObject.tag == "WhitePiece" && Turn.whiteTurn && pieceIsGrabbed){ //This is white turn
